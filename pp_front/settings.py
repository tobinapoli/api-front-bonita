...
# Proceso ONG / Project Planning
BONITA_PROCESS_NAME = os.getenv("BONITA_PROCESS_NAME", "ProjectPlanning")
BONITA_PROCESS_VERSION = os.getenv("BONITA_PROCESS_VERSION", "1.0")
